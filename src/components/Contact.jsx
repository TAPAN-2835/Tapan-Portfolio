...
>>>>>>> 43a7a6b (Initial commit: Portfolio UI/UX improvements and architectural refinements)
  ...
  return (
    <section id="contact" className="py-20 px-4 bg-gray-900/80" ref={ref}>
...
=======
        <div className="bg-gray-800/40 backdrop-blur-md rounded-3xl p-8 md:p-12 border border-gray-700 shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-cyan-500/5 blur-3xl -z-10" />
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-purple-500/5 blur-3xl -z-10" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 relative z-10">
            ...
            >
              ...
              <div className="space-y-6">
                <motion.div
                  className="flex items-center gap-4 p-4 bg-gray-900/50 rounded-lg border border-gray-700 hover:border-cyan-400 transition-colors"
                  whileHover={{ scale: 1.02 }}
                >
                  <div className="w-12 h-12 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-full flex items-center justify-center">
                    <Mail className="text-white" size={20} />
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      required
                      className="w-full px-4 py-3 bg-gray-900 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:border-cyan-400 focus:outline-none transition-colors"
                      placeholder="Your Name"
                    />
                    {errors.name && <div className="text-red-400 text-sm mt-1">{errors.name}</div>}
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={6}
                    className="w-full px-4 py-3 bg-gray-900 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:border-cyan-400 focus:outline-none transition-colors resize-none"
                    placeholder="Tell me about your project..."
                  />
                  {errors.message && <div className="text-red-400 text-sm mt-1">{errors.message}</div>}
                </div>
